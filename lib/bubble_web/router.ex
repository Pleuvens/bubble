defmodule BubbleWeb.Router do
  ...
  scope "/", BubbleWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{BubbleWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", BubbleWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{BubbleWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", BubbleWeb do
    ...
    live_session :current_user,
      on_mount: [{BubbleWeb.UserAuth, :mount_current_user}] do
